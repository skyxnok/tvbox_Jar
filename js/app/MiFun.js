...
try{
host = (await req('https://miget-1313189639.cos.ap-guangzhou.myqcloud.com/mifun.txt')).content?.split('\r\n')[1]
}catch(e){
...
//解密
function de(data) {
const key = 'GETMIFUNGEIMIFUN';
const iv  = 'GETMIFUNGEIMIFUN';
...
return {
    ...
    "app-ui-mode": "light",
    "app-user-device-id": "26e450813c3ad3936acb7fbecfc249d1b",
